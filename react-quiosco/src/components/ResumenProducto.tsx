...
import { pedido } from "../interfaces/Quiosco";
interface ResumenProductoProps {
  producto: pedido;
}

function ResumenProducto({ producto }: ResumenProductoProps) {
  const { handleEditarCantidad, handlerEliminarProductoPedido } = useQuiosco();
    ...
    <div className="shadow space-y-1 p-4 bg-white">
      ...
      <div className="flex justify-between gap-2 pb-4">
        ...
        <button
          ...
          onClick={() => {
            handlerEliminarProductoPedido(id);
          }}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
